...
india_image= ImageTk.PhotoImage(Image.open ("indiamap.jpg"))
usa_image= ImageTk.PhotoImage(Image.open ("map-of-usa.jpg"))
australia_image= ImageTk.PhotoImage(Image.open ("australia-map.jpg"))
